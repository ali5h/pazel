...
from pazel.bazel_rules import get_native_bazel_rules
from pazel.bazel_rules import infer_bazel_rule_type
from pazel.bazel_rules import PyBinaryRule
from pazel.bazel_rules import PY_BINARY_TEMPLATE
from pazel.bazel_rules import PyLibraryRule
from pazel.bazel_rules import PY_LIBRARY_TEMPLATE
from pazel.bazel_rules import PyTestRule
from pazel.bazel_rules import PY_TEST_TEMPLATE
...
py_test(
    ...
    deps = ["//pazel:bazel_rules"],
        ...
        self.assertIsNotNone(
            BazelRule.find_existing(build_source, "test_bazel_rules.py")
        )
...
class TestPyBinaryRule(unittest.TestCase):
    ...
    def test_applies_to(self):
        ...
        self.assertEqual(
            PyBinaryRule.applies_to(script_name, binary_with_main_source), True
        )

        # Ditto for a level 0 function call.
        self.assertEqual(
            PyBinaryRule.applies_to(script_name, binary_without_main_source), True
        )
...
class TestPyLibraryRule(unittest.TestCase):
    ...
    def test_applies_to(self):
        ...
        self.assertEqual(
            PyLibraryRule.applies_to(script_name, binary_with_main_source), False
        )
        self.assertEqual(
            PyLibraryRule.applies_to(script_name, binary_without_main_source), False
        )
...
class TestPyTestRule(unittest.TestCase):
    ...
    def test_applies_to(self):
        ...
        self.assertEqual(
            PyTestRule.applies_to(script_name, binary_with_main_source), False
        )
        self.assertEqual(
            PyTestRule.applies_to(script_name, binary_without_main_source), False
        )
...
class TestBazelRuleInference(unittest.TestCase):
    ...
    def test_infer_bazel_rule_type(self):
        ...
        self.assertEqual(
            infer_bazel_rule_type(script_name, binary_with_main_source, custom_rules),
            PyBinaryRule,
        )
        self.assertEqual(
            infer_bazel_rule_type(
                script_name, binary_without_main_source, custom_rules
            ),
            PyBinaryRule,
        )
        self.assertEqual(
            infer_bazel_rule_type(script_name, module_source, custom_rules),
            PyLibraryRule,
        )
        self.assertEqual(
            infer_bazel_rule_type(test_script_name, test_source, custom_rules),
            PyTestRule,
        )
